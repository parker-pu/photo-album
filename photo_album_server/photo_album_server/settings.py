"""
Django settings for photo_album_server project.
...
SECRET_KEY = '!v2g2mlvr=dqlcsv0f_s1mjbsp&v2f^h-kid@_hv91hko6r_pn'
...
ROOT_URLCONF = 'photo_album_server.urls'
...
WSGI_APPLICATION = 'photo_album_server.wsgi.application'
